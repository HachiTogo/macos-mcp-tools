...
export function addOptionalArg(args: string[], flag: string, value: string | undefined): void {
  if (value !== undefined) {
    args.push(flag, value)
  }
}

export function addOptionalBooleanArg(args: string[], flag: string, value: boolean | undefined): void {
  if (value !== undefined) {
    args.push(flag, String(value))
  }
}

export function addOptionalNumberArg(args: string[], flag: string, value: number | undefined): void {
  if (value !== undefined) {
    args.push(flag, String(value))
  }
}

export function addOptionalJsonArg(args: string[], flag: string, value: object | undefined): void {
  if (value) {
...
export const extractAndValidateArgs = <T>(
  args: RemindersToolArgs | ListsToolArgs | SubtasksToolArgs | CalendarToolArgs | CalendarsToolArgs | undefined,
  schema: z.ZodType<T>,
): T => {
